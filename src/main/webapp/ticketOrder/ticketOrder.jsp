...
<c:forEach var="ActivityVO" items="${list}">
						<tbody>
							<tr>
								<td class="product-thumbnail"><img
									src="images/exhibition pic.jpg" alt="Image" class="img-fluid">
									${acitivtyVO.actCoverPicture}
								</td>
								<td class="product-name">
									<h2 class="h5 text-black" id="actName">${ActivityVO.actName}</h2>
								
								</td>
								<td class="price" id="actTicketPrice">${ActivityVO.actTicketPrice}</td>
		...
		<div class="container">
			...
			<div class="money">
				<span class="text-black">小計</span> <strong
					class="price_smallcount text-black" id=ticketOrdTotalPrice>${ticketOrderVO.ticketOrdTotalPrice}</strong>
			</div>
			<br>
			<div class="money1">
				<span class="price_discount1 text-black">折扣金額</span> <strong
					class="price_discount text-black" id="ticketOrdProCodeAmount">${ticketOrderVO.ticketOrdProCodeAmount}</strong>
			</div>
			<br>
			<div class="money2">
				<span class="text-black2">商品總金額</span> <strong
					class="price_all text-black" id="ticketOrdActuallyAmount">${ticketOrderVO.ticketOrdActuallyAmount}</strong>
			</div>
		</div>
		...
		<input type="text" class="form-control" id="coupon"
			placeholder=${promoCodeVO.proCodeCode}>
