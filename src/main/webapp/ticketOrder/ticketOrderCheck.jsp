				...
				<div class="container">
					<div class="row justify-content-between">
						...
						<div class="col-lg-7">
         		            	...
         		            	<FORM METHOD="post" ACTION="<%= request.getContextPath() %>/TicketOrderServlet" name="form1">
		              ...
		              <div class="p-3 p-lg-5 border bg-white">
		                ...
		                <table class="table site-block-order-table mb-5">
		                  ...
		                  <tbody>
		                    ...
		                    <tr>
		                  <%--  <td><input type="hidden" name="ticketOrdId"   value= ""  size="45"/></td>
		                    <td><input type="hidden" name="ticketOrdTime"   value= ""  size="45"/></td> --%>
		                    
		                    <td><input type="hidden" name="ticketOrdStatus"   value= "1"  size="45"/></td>
		                 
		                  
		                    <td><input type="hidden" name="member"   value= "7001"  size="45"/></td>
		                    <td><input type="hidden" name="ticketOrdPayStatus"   value= "1"  size="45"/></td>
		                    <td><input type="hidden" name="mypromocode"   value= "12345"  size="45"/></td>
		                    <td><input type="hidden" name="ticketOrdAddress"   value= "新北市三芝區"  size="45"/></td>
		                    <td><input type="hidden" name="seller"   value= "12345"  size="45"/></td>
		                    <td><input type="hidden" name="ticketOrdCode"   value= "12345"  size="45"/></td>
		                    ...
		                    <tr>
		                      ...
		                      <input type="text" name="ticketOrdTotalPrice"   value= "1000"  size="45"/></td></td>
		                    </tr>
							<tr>
								<td class="text-black font-weight-bold"><strong>折扣金額</strong></td>
								<td class="text-black"><td>
								<input type="text" name="ticketOrdProCodeAmount"   value= "100.0"  size="45"/></td>
								</td>
							</tr>
		                    ...
		                    <tr>
		                      ...
		                      <td><input type="text" name="ticketOrdActuallyAmount"   value= "800.0"  size="45"/></td></strong></td>
		                    </tr>
		                  </tbody>
		                </table>
						...
						<div class="row mb-5"> 
							...
							<button class="btn_checkorder" onclick="window.location='thankyou.html'">
									<input type="hidden" name="action" value="insert">
									<input type="submit" value="下訂單"></button>
						</div>		        		               
						</div>
		              </div>
		            </div>
