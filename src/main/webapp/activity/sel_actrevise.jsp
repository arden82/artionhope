								...
								<div class="col">
									<div class="mb-2">
										<div class="form-group">
											<label for="actId" class="form-label">活動編號</label>
											<div class="d-flex">
											...
											<div class="col">
												<div class="mb-4">
													<label for="acttype" class="form-label">活動類型</label> <select
														...
														<option value="1"
															<c:if test="${activityVO.actType == 1}">selected</c:if>>展覽</option>
														<option value="2"
															<c:if test="${activityVO.actType == 2}">selected</c:if>>市集</option>
														<option value="3"
													...
													<div class="form-group">
														...
														<div class="d-flex">
															<input type="date" class="form-control"
																...
																value="<%=activityVO.getActTicketStartTime()%>">
														</div>
													</div>
												</div>
											</div>
												...
												<div class="mb-2">
													...
													<div class="d-flex">
														<input type="date" class="form-control"
															...
															value="<%=activityVO.getActTicketEndTime()%>">
													</div>
												</div>
											</div>
										</div>
													...
													<div class="form-group">
														...
														<div class="d-flex">
															<input type="time" class="form-control"
																...
																value="<%=activityVO.getActStartTime()%>">
														</div>
													</div>
												</div>
											</div>
												...
												<div class="mb-2">
													...
													<div class="d-flex">
														<input type="time" class="form-control" name="actEndTime"
															id="actEndTimeInput"
															value="<%=activityVO.getActEndTime()%>">
													</div>
												</div>
											</div>
										</div>
