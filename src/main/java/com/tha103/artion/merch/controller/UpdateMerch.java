...
@WebServlet("/updateMerch")
@MultipartConfig
public class UpdateMerch extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		// =============接受請求參數===============================
				...
				try {
					...
					Integer merchId = Integer.valueOf(strMerchId);
					...
					//不修改
					merchVO.setMerchId(merchSvc.getMerchByMerchId(merchId).getMerchId());

					// 調用新增方法

					int addResult = merchSvc.updateMerch(merchVO);
